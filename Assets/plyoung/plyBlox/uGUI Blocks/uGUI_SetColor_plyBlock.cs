...
{
	[plyBlock("GUI", "uGUI", "Set Colour", BlockType.Action, Order = 0,
		Description = "Set the Color on UI Component of GameObject.")]
	public class uGUI_SetColor_plyBlock : plyBlock
	{
		[plyBlockField("Set Color =", SubName = "Value - Color", ShowName = true, ShowValue = true, EmptyValueName="-black-", DefaultObject=typeof(Color_Value), Description = "The value to apply. Leaving this value empty will clear the target field.")]
		public Color_Value val;
		...
		private UnityEngine.UI.Graphic c = null; // cached component
		...
		public override BlockReturn Run(BlockReturn param)
		{
			if (c == null)
			{
				...
				if (go != null)
				{
					c = go.GetComponent<UnityEngine.UI.Graphic>();
					if (c == null)
					{
				...
				{
					c = obj as UnityEngine.UI.Graphic;
					if (c == null)
					{
			...
			c.color = (val == null ? Color.black : val.RunAndGetColor());
