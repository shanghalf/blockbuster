...
{
	[plyBlock("GUI", "uGUI", "Set Toggle", BlockType.Action, Order = 0,
		Description = "Set the Toggle UI Component of GameObject to On or Off.")]
	public class uGUI_SetToggleOn_plyBlock : plyBlock
	{
		[plyBlockField("Set Toggle isOn =", SubName = "Value - Boolean", ShowName = true, ShowValue = true, EmptyValueName = "-false-", DefaultObject = typeof(Bool_Value), Description = "The value to apply. Leaving this value empty will clear the target field.")]
		...
		public override BlockReturn Run(BlockReturn param)
		{
			...
			c.isOn = (val == null ? false : val.RunAndGetBool());
