...
{
	[plyBlock("GUI", "uGUI", "Set Sprite", BlockType.Action, Order = 0,
		Description = "Set the Source Image (Sprite) on Image Component of GameObject.")]
	public class uGUI_SetSprite_plyBlock : plyBlock
	{
		[plyBlockField("Set Source Image =", SubName = "Value - Sprite", ShowName = true, ShowValue = true, EmptyValueName="-none-", BasicTypeHint=typeof(Sprite), Description = "The value to apply. Leaving this value empty will clear the target field.")]
		...
		private UnityEngine.UI.Image c = null; // cached component
		...
		public override BlockReturn Run(BlockReturn param)
		{
			if (c == null)
			{
				...
				if (go != null)
				{
					c = go.GetComponent<UnityEngine.UI.Image>();
					if (c == null)
					{
			...
			c.sprite = (val == null ? null : (Sprite)val.RunAndGetUnityObject());
