...
{
	[plyBlock("GUI", "uGUI", "Get Slider Value", BlockType.Variable, Order = 0,
		ReturnValueString = "Return - Float", ReturnValueType = typeof(Float_Value),
		Description = "Get the Value from Slider UI Component of GameObject.")]
	public class uGUI_GetSliderValue_plyBlock : Float_Value
	{
		...
		private UnityEngine.UI.Slider c = null; // cached component
		...
		public override BlockReturn Run(BlockReturn param)
		{
			if (c == null)
			{
				...
				if (go != null)
				{
					c = go.GetComponent<UnityEngine.UI.Slider>();
					if (c == null)
					{
				...
				{
					c = obj as UnityEngine.UI.Slider;
					if (c == null)
					{
