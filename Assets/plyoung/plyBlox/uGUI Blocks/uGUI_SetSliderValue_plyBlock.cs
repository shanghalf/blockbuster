...
{
	[plyBlock("GUI", "uGUI", "Set Slider Value", BlockType.Action, Order = 0,
		Description = "Set the Value on Slider UI Component of GameObject.")]
	public class uGUI_SetSliderValue_plyBlock : plyBlock
	{
