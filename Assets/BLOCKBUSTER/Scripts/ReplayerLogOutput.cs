...
public class ReplayerLogOutput : MonoBehaviour
{
    ...
    protected void OnDestroy()
    {
        ...
        string outPath = string.Format("{0}/BLOCKBUSTER/XML/Replays/{1}{2}{3}.xml", Application.dataPath, m_mapname, System.DateTime.Now.ToString().Replace('/', '_').Replace(' ', '-').Replace(':', '_'), m_entityname);
